...
router.delete('/deletesession/:id',auth.verifyUser, auth.checkAdmin, async(req,res,next)=>{
  ...
  router.patch('/updatesession/:id',auth.verifyUser, auth.checkAdmin, async(req,res,next)=>{
