...
import { GacSidebarList } from "../Components/UI/GAC/GacSidebarList";
...
function DashboardContent() {
  ...
  const checkActiveTab = (tab) => {
    if (tab === "HOME") {
      return <h1 style={{ textAlign: "center" }}>Welcome! GAC</h1>;
    }
    ...
    <ThemeProvider theme={mdTheme}>
      <Box sx={{ display: "flex" }}>
        ...
        > */}
          ...
          <List wrap>
            {/* <Sidebar /> */}
            <GacSidebarList onActiveTab={setActiveTab} />
          </List>
          {/* <Divider />
...
export default function GacDashboard() {
