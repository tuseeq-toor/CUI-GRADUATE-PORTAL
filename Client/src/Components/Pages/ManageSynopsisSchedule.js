...
export default function ManageSynopsisSchedule() {
  ...
  async function getData() {
    const res = await synopsisService.getSynopsisSchedules();
    console.log(res);
        ...
        <>
          <Button
            onClick={async () => {
              ...
              const res = await synopsisService.deleteSchedule(props.row.id);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      let res = await synopsisService.updateSchedule(selectedSchedule.id, {
